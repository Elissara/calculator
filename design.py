...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/calculate_white_24dp.svg", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.gridLayout.addWidget(self.btn_result, 4, 3, 1, 1)
...
#if QT_CONFIG(shortcut)
        self.btn_clear.setShortcut(QCoreApplication.translate("MainWindow", u"Backspace", None))
#endif // QT_CONFIG(shortcut)
